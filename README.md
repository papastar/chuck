Chuck
=====
[![](https://jitpack.io/v/papastar/chuck.svg)](https://jitpack.io/#papastar/chuck)
...
```gradle
 dependencies {
   debugCompile 'com.papa.chuck:library:1.1.1'
   releaseCompile 'com.papa.chuck:library-no-op:1.1.1'
 }
```
